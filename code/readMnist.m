function [imgs, labels] = readMnist(imgFile, labelFile, readDigits, offset, trimBorder)
%READMNIST Read MNIST dataset files.
%
% Description:
% Read digits and labels from raw MNIST data files
% File format as specified on http://yann.lecun.com/exdb/mnist/
% Note: The 4 pixel padding around the digits will be removed
...
if trimBorder
  imgs = trimDigits(imgs, 4); % Trim border
end
